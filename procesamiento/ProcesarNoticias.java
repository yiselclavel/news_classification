package irony_detection.procesamiento;
...
//            File classDir = new File(file, CATEGORIES[i]);
//            if (!classDir.isDirectory()) {
//                String msg = "Ocurrió un error durante el proceso de entrenamiento.\nNo se puede encontrar el directorio de entrenamiento = " + classDir+".";
//                //System.out.println(msg); // in case exception gets lost in shell
//                JOptionPane.showMessageDialog(ClasificadorDeNoticiasApp.getApplication().getMainFrame(), msg, "Mensaje de Error", JOptionPane.ERROR_MESSAGE);
//                System.exit(1);
//            }
