...
import clasificacion_noticias.procesamiento.ProcesarNoticias;
...
public class ClasificarNoticias {
    ...
    public static File originalExternalNews_DIR = new File("datos/Noticias Originales"); //dir de noticias externas a preprocesar
    public static File ExternalNews_DIR = new File("datos/Noticias Procesadas"); //dir de noticias externas a clasificar
